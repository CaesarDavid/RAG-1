defmodule LocalRag.Application do
  ...
  def start(_type, _args) do
    children = [
      ...
      LocalRagWeb.Endpoint
    ]

    # See https://hexdocs.pm/elixir/Supervisor.html
    # for other strategies and supported options
    opts = [strategy: :one_for_one, name: LocalRag.Supervisor]
  ...
  def config_change(changed, _new, removed) do
    LocalRagWeb.Endpoint.config_change(changed, removed)
    :ok
  end
end
